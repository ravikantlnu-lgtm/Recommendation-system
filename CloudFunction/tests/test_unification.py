...
def test_unification(mock_data_dict):
    """Test the unification endpoint locally"""
    ...
    try:
        ...
        response = unification(mock_request)
        ...
        assert (
            response["log_message"] == "Unification process completed successfully."
        )
...
if __name__ == "__main__":
    ...
    print("Starting local test of unification.py...")
    ...
    try:
        ...
        # 5. Run the test
        test_unification(mock_data_dict)
